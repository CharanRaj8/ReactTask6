    ...
    <div className="App">
      ...
      <main className="App-main">
        <section className="App-section" id="about">
          ...
          <p>My name is Borugadda Charan Raj.</p><br/>
          ...
          <p> I had completed my schooling at Siddhartha Public School in Venkata Krishna Puram.</p>
        ...
        <section className="App-section colorful" id="contact">
          <h2>Contact Me</h2>
          <p>Contact me: <a href="mailto:borugaddacharan143@gmail.com">borugaddacharan143@gmail.com</a></p>
          <p>Phone Number: 9652734015</p>
        </section>
      </main>
